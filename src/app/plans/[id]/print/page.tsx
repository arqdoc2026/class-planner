...
export default async function PrintPlanPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="bg-slate-200 py-8 print:bg-white print:py-0"><div className="mx-auto mb-4 flex max-w-[8.5in] justify-end print:hidden"><PrintButton /></div><InstitutionalPlanDocument plan={plan} /></main>;
}
